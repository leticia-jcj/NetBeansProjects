...
//diferença. (faça usando condicionaL– composta if (opcao != codigoCargo)
...
public class Exercicio4Composta {
    ...
    salario = teclado.nextDouble();
        ...
        if (codigoCargo == 101) {
        System.out.println("101 - GERENTE - REAJUSTE DE 10%: R$ " + (salario + (salario*0.01)));
        System.out.println("    - SALÁRIO ANTIGO: R$ " + salario);
        }
        
        else if (codigoCargo == 102) {
        System.out.println("102 - ENGENHEIRO - REAJUSTE DE 20%: R$ " + (salario + (salario*0.02)));
        System.out.println("    - SALÁRIO ANTIGO: R$ " + salario);
        }
        
        else if (codigoCargo == 103) {
        System.out.println("103 - TÉCNICO - REAJUSTE DE 30%: R$ " + (salario + (salario*0.03)));
        System.out.println("    - SALÁRIO ANTIGO: R$ " + salario);
        }
